...
_Showing findings at or above `LOW` (6 of 6 total)._
...
- 🟡 **F-004** [NAV2_VELOCITY_OVERDECLARED] Controller declares maximum forward velocity 1.92x the downstream smoother limit
- 🟡 **F-005** [NAV2_VELOCITY_OVERDECLARED] Controller declares maximum reverse velocity 1.35x the downstream smoother limit
- 🟡 **F-006** [NAV2_VELOCITY_OVERDECLARED] Controller declares maximum angular velocity 1.90x the downstream smoother limit